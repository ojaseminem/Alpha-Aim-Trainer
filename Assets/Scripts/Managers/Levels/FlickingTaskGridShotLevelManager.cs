...
namespace Levels
{
    public class FlickingTaskGridShotLevelManager : MonoBehaviour
    {
        #region Singleton

        public static FlickingTaskGridShotLevelManager Instance;
        ...
        private void Start()
        {
            ChangeState(FlickingTaskGridShot.PreGame);
            maxTargetCount = 51;
        }

        private void ChangeState(FlickingTaskGridShot flickingTaskGridShot)
        {
            switch (flickingTaskGridShot)
            {
                case FlickingTaskGridShot.PreGame:
                    SetVariables();
                    UnlockAimDisableCursor();
                    StartCoroutine(StartTask());
                    break;
                case FlickingTaskGridShot.Game:
                    SpawnTargets();
                    break;
                case FlickingTaskGridShot.PostGame:
        ...
        private IEnumerator StartTask()
        {
            ...
            ChangeState(FlickingTaskGridShot.Game);
        }
        ...
        public void IncrementHits()
        {
            ...
            _currentTargetCount++;
            if(_currentTargetCount >= maxTargetCount) ChangeState(FlickingTaskGridShot.PostGame);
        }
    ...
    public enum FlickingTaskGridShot
    {
        PreGame,
        Game,
        PostGame
